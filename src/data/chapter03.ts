    ...
    lines: [
      {
        speaker: "Нарратор",
        kind: "narrator",
        text: "Дверь распахнулась. На пороге стояла устрашающая фигура в тени — без лица, без имени, только контур беды.",
      },
      {
        speaker: "Женек",
        kind: "dialog",
    ...
    lines: [
      {
        speaker: "Вадим",
        kind: "dialog",
        text: "Чуваки… я вчера записал пятьдесят один трек. Не хотите послушать?",
      },
      {
        speaker: "Нарратор",
        kind: "narrator",
    ...
    lines: [
      {
        speaker: "Вадим",
        kind: "dialog",
        text: "Да шучу я. Всего лишь три трека, чуваки. В жанре скибиди лап пап пап))",
      },
      {
        speaker: "Нарратор",
        kind: "narrator",
  ...
  },
  {
    ...
    lines: [
      ...
      },
      {
        speaker: "Нарратор",
        kind: "narrator",
        text: "Женек резко очутился на Марсе — прыгал среди паровых машин, гари и корпорации городских сумасшедших.",
      },
      {
        speaker: "Женек",
        kind: "dialog",
        text: "Это… это скибиди лап пап пап?!",
      },
    ],
  },
  {
    ...
    lines: [
      {
        speaker: "Нарратор",
        kind: "narrator",
        text: "Олег оказался в психоделическом мире, полном электрических схем и неопознанных биотварей.",
      },
      {
        speaker: "Олег",
        kind: "dialog",
        text: "Схема… живая… она на меня смотрит…",
      },
      {
        speaker: "Нарратор",
        kind: "narrator",
